  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="bg-gray-100 rounded-full px-4 py-1 mb-4">
              <span className="text-sm text-gray-700">
                <span className="text-gray-800">Apple</span> <span className="text-purple-500">iPad</span>
              </span>
            </div>
            
            {/* Subtitle */}
            <p className="text-gray-600 text-lg mb-6">Lovable. Drawable. Magical.</p>
            
            {/* Main Heading */}
            <h1 className="text-center text-5xl md:text-6xl lg:text-7xl font-semibold mb-8">
              Find the right <span className="text-purple-600">iPad</span> for you.
            </h1>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Available iPad Products</h2>
          {products.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg">No iPad products available at the moment.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-4">
            <p className="text-gray-600 text-lg">
              Discover the whole Apple iPad lineup at iFive and experience them firsthand in our premium stores.
            </p>
            <p className="text-gray-600 text-lg">
